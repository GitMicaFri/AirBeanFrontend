...
export const productList = [
    ...
    { name: 'LatteMacchiato', price: 49, description: 'Bryggd på månadens bönor'},
    ...
    return {
        ...
        addProduct: (productName) => {
            return set((currentState) => {
                ...
                const newState = { // Skapa en uppdaterad version av objektet "products", där ny antalet av den produkten jag skickar in, ökar med 1
                    ...currentState,
                    products: {
        ...
        removeProduct: (productName) => {
            return set((currentState) => { // Vi använder "productIndex" för att peka ut vilket element i arrayen "products" vi vill ta bort
                const currentStateProducts = {...currentState.products}
                ...
                if (currentProductAmount === 0) {  // Om det inte finns någon produkt kvar, håll antalet som 0
                    newProductAmount = 0
                } else {
